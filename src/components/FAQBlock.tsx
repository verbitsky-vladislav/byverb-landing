...
export default function FAQBlock() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4">
      {/* Заголовок */}
      <div className={`text-center mb-8 xs:mb-10 sm:mb-12 transition-all duration-1000 ease-out ${
        isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
      }`}>
        <h2 className={`text-2xl xs:text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-inter-black mb-4 xs:mb-6 text-black transition-all duration-1000 ease-out delay-200 ${
          isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
        }`}>
          FAQ
        </h2>
      ...
      <div className="space-y-2 xs:space-y-3">
        {faqData.map((item, index) => {
          ...
          return (
            <div
              key={item.id}
              className={`bg-white border border-gray-200 rounded-xl xs:rounded-2xl overflow-hidden shadow-sm transition-all duration-300 hover:shadow-md transition-all duration-1000 ease-out ${
            ...
            >
              ...
              >
                <h3 className={`text-base xs:text-lg sm:text-xl font-medium text-black pr-4 xs:pr-6 leading-relaxed group-hover:text-red-500 transition-colors duration-300 transition-all duration-1000 ease-out delay-200 ${
                ...
                <div className="flex-shrink-0">
                  <div className={`w-6 h-6 xs:w-8 xs:h-8 rounded-full flex items-center justify-center transition-all duration-300 transition-all duration-1000 ease-out delay-300 ${
              ...
              >
                <div className="px-4 xs:px-6 pb-3 xs:pb-4">
                  <p className={`text-sm xs:text-base text-gray-600 leading-relaxed transition-all duration-1000 ease-out delay-400 ${
                    isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
      ...
      {/* CTA блок */}
      <div className={`mt-8 xs:mt-10 sm:mt-12 text-center transition-all duration-1000 ease-out delay-1100 ${
        isLoaded ? 'opacity-100 translate-y-0 scale-100' : 'opacity-0 translate-y-8 scale-95'
      }`}>
